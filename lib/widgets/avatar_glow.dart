...
class AvatarG extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<AvatarG> createState() => _AvatarGState();
}

class _AvatarGState extends State<AvatarG> with SingleTickerProviderStateMixin {
  ...
  void _statusListener(AnimationStatus status) async {
    if (controller.status == AnimationStatus.completed) {
      ...
      if (mounted && widget.repeat && widget.animate) {
        _resetAndForwardController();
      }
    }
  }

  void _resetAndForwardController() {
    controller.reset();
    controller.forward();
  }
  ...
  @override
  void didUpdateWidget(AvatarG oldWidget) {
